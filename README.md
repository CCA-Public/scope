...
* [Server-side processing](https://datatables.net/examples/data_sources/server_side.html) or switch to ES/Solr for large datatables - particularly for interface-wide search
